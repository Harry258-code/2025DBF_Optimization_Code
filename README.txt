Score_Prediction.m is the only relevant file for working through configuration and setting limits. This is the file to run to get top three (or more) configurations. 
